...
var cnItems = {
    ...
    "Create an outstanding wig": "打造出众的假发",
    ...
    "Nylon": "尼龙",
    "Nylon wig caps are the basis of all good wigs": "尼龙假发上限是所有好假发的基础",
    "Wig cap (1 nylon": "假发上限（1 尼龙",
    "Yet another fine wig": "又一个漂亮的假发",
    "Create a distinguished wig": "打造出众的假发",
    "Create a monumental wig": "创造一个不朽的假发",
    "Create a remarkable wig": "打造非凡的假发",
    "Create an elegant wig": "打造优雅的假发",
    "Create an extraordinary wig": "打造非凡的假发",
    "Marvelous": "了不起",
    "Simply divine": "简直是神",
